...
thin.init_ = function () {
  ...
  (function () {
    ...
    // Export ID-Structure
    var exportTypes = [{
        type: thin.layout.document.Type.HTML,
        label: thin.t('button_export_document_as_html')
      },
      {
        type: thin.layout.document.Type.CSV,
        label: thin.t('button_export_document_as_csv')
      }
    ];
    var exportMenuItem;
